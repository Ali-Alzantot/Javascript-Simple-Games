...
function funcRef (){
    ...
    let pos = 0;  let emptypiece;  let url = "./images/1.jpg";
                ...
                for (let i = 0; i < piece.length; i++) {
                     piece[i].addEventListener("click", function(event){
                         ...
                         function getPicture (selectedVal) {
                             switch (selectedVal) {
                                  case "1":  url = "./images/1.jpg";  break;
                                  case "2":  url = "./images/2.jpg";  break;
                                  case "3":  url = "./images/3.jpg";  break;
                             }
                            for(let i = 0; i < piece.length; i++) {
                                 piece[i].style.backgroundImage = "url(" + url + ")";
                        ...
                        select.addEventListener("change", function(){selectedVal = select.value;removeClasses();defaultClassesOrder();getPicture(selectedVal);  });   
